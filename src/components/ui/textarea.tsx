    ...
    function Textarea(
        ...
        return (
            <textarea
                ...
                className={cn(
                    // base — campo afundado em cinza neutro pra se
                    // manter idêntico em qualquer fundo (wallpaper,
                    // card glass, dialog opaco).
                    "flex min-h-24 w-full resize-y rounded-(--r-3) border border-hairline border-(--line-strong) bg-(--bg-sunk) px-3 py-2 text-sm",
                    // tinta + placeholder
