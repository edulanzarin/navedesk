    ...
    function Textarea(
        ...
        return (
            <textarea
                ...
                className={cn(
                    // base — glass leve, mesmo padrão do Input.
                    "flex min-h-24 w-full resize-y rounded-(--r-3) border border-hairline border-(--line) bg-white/45 backdrop-blur-md px-3 py-2 text-sm",
                    // tinta + placeholder
